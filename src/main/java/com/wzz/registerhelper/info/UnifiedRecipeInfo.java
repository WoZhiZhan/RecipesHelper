...
public class UnifiedRecipeInfo {
    ...
    public String getStatusText() {
        if (isBlacklisted) return Component.translatable("registerhelper.recipe.status.disabled").getString();
        if (hasOverride) return Component.translatable("registerhelper.recipe.status.overridden").getString();
