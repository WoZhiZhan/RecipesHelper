...
public class ModIntegrations {
    public static void registerAll() {
        ...
        RegisterHelper.registerRecipeTypeWithLayout("mysticalagriculture", "awakening",
                "registerhelper.recipe_type.mod.mystical_awakening", new MysticalAgricultureProcessor(), "infusion");
        ...
        RegisterHelper.registerRecipeTypeWithLayout("astralrail_cube", "path_ascension",
                "registerhelper.recipe_type.mod.astralrail_ascension", 2, new AstralrailCubeProcessor(), "path_ascension");
        RegisterHelper.registerRecipeTypeWithLayout("astralrail_cube", "path_transmuter",
                "registerhelper.recipe_type.mod.astralrail_transmuter", new AstralrailCubeProcessor(), "path_transmuter");
