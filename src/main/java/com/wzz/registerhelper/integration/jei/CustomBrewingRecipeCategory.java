...
public class CustomBrewingRecipeCategory extends AbstractRecipeCategory<JEIBrewingRecipe> {
    ...
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath("registerhelper", "custom_brewing");
    ...
    public @Nullable ResourceLocation getRegistryName(JEIBrewingRecipe recipe) {
        return ResourceLocation.fromNamespaceAndPath("registerhelper", "brewing_" + recipe.hashCode());
    }
}