...
public final class GuiLayoutHelper {
    ...
    /** Fits a preferred dimension into the available space while preserving a usable minimum. */
    ...
    /** Returns a string that fits in maxWidth, preserving a suffix ellipsis where possible. */
